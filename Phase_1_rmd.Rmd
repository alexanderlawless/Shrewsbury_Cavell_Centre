...
phase_2_input <-
  ...
  mutate(ASC_place_holder = total_activity * 0.1) %>% # 10% of total activity allocated to ASC
...
Without access to individual level GP data, we will not be able to account for multi-morbidity, that is, we will present the combined volume of patients across the 8 practices who are known to have heart disease for example, alongside the number of COPD, but not the number with both conditions. 
...
<div class="warning" style='padding:0.1em; background-color:#f9bf07; color:#2c2825'>
<span>
<p style='margin-top:1em;'>
<b>Appointments suitable for collocation include:</b></p>
...
<p style='margin-top:1em;'>
<b>Outpatient appointments not suitable include:</b></p>
...
<span>
<p style='margin-top:1em;'>
<b>Contacts suitable for collocation include:</b></p>
...
<p style='margin-top:1em;'>
<b>Community contacts excluded are:</b></p>
...
<span>
<p style='margin-top:1em;'>
<b>Diagnostic activity inclusion:</b></p>
...
<span>
<p style='margin-top:1em;'>
<b>Mental health contacts not suitable for collocation include:</b></p>
...
<span>
<p style='margin-top:1em;'>
<b>All IAPT therapy types and patient groups considered suitable for collocation</b></p>
</p>
</p></span>
</div>
...
<span>
<p style='margin-top:1em;'>
<b>All ante-natal contacts considered suitable for collocation.</b></p>
</p>
</p></span>
</div>
...
phase_2_input %>% 
  ...
  mutate(activity_group = 
           case_when(
             ...
             str_detect(name, "ASC") ~ "Shrop Council - place holder (10%)"
             )) %>% 
